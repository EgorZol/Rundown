...
def build_ask_stable_prompt(_user_id_str: str) -> str:
    ...
    return (
            ...
            "Инцидент-пример: бот верно посчитал 76 г белка (SQL: 12.4+27.9+5.3+12.5+17.5), юзер настаивал "
            "на 58 (видел вечерний отчёт до последнего ужина: 12.4+27.9+5.3+12.5=58.1) — бот извинился "
            "и принял НЕВЕРНЫЕ 58. Юзер ушёл с ложной цифрой и недоверием к боту.\n"
