...
"""
    ...
    async def ask(
        ...
        stable_part = (
            ...
            "  • новая будущая гонка с датой. Сейчас лучший вариант — confirm_fact «добавить гонку <дата> <название>».\n"
            "    Юзер увидит факт и при необходимости заведёт через кнопку «🏁 Старты».\n"
            "  • вес → кнопка «⚖ Вес».\n"
            "  • LTHR → кнопка «💓 LTHR».\n"
            "  • часовой пояс → кнопка «🕐 Часы».\n"
            "  • еда — отдельный пайплайн: кнопка «🍽 Еда» (фото/голос/текст). НЕ записывай через confirm_fact.\n"
            ...
            "• Кнопки (главный интерфейс — на них направляй пользователя): "
            "🌅 Утро · 🏃 Разбор · 🏅 Форма · 📅 План · 📈 Прогресс · 📋 Итоги · 🎯 Моя цель · "
            "🏁 Старты · 🔥 Калории · 🍽 Еда · 📊 Питание · 🏆 Рекорды · 📊 Статус · 📋 Профиль · "
            "🕐 Часы · ⚖ Вес · 💓 LTHR.\n"
